    ...
    return (
        <div className="bg-white flex flex-row justify-center w-full h-screen">
            <div className="bg-white w-full h-full relative overflow-auto">
                <div className="absolute w-[295px] h-[19px] top-[803px] left-[185px]">
                    ...
                    <Link to="/sign-in" className="absolute top-0 left-[220px] [font-family:'Inter-Medium',Helvetica] font-medium text-[#6b6bf9] text-base tracking-[1.60px] leading-[normal] whitespace-nowrap">
                        Create Account
                    </Link>
                </div>

                <div className="absolute w-[388px] h-[33px] top-[357px] left-[159px]">
                ...
                <div className="absolute w-[388px] h-8 top-[462px] left-[159px]">
